    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/auth/login", "/h5/auth/login", "/auth/logout", "/auth/register", "/h5/auth/register", "/auth/sms-code", "/h5/auth/sms-code", "/auth/phone-login", "/h5/auth/phone-login", "/auth/wechat-login")
                        .permitAll()
                        // 媒体文件访问公开（用于前端展示）
