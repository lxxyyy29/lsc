...
本仓库包含东莞杰瑞智慧网格治理平台的四个应用，分别面向后端接口、Web 管理端、H5 移动端和居民小程序。四个应用共同支撑"发现上报→智能派单→现场处置→复核核查→督办预警→归档"全流程闭环管理。
...
- `docs/`
  ...
  - `docs/系统说明文档.md`：完整接口文档(403 端点全量收录，含 4.35 节 V81~V96 新增模块；2026-08-17 补全)
...
| 容器 | 端口 | 说明 |
|------|------|------|
| dgjr-backend | 9072 | 后端 API |
| dgjr-web | 9071 | Web 管理端 |
| dgjr-web | 9075 | HTTPS 聚合入口（代理 /h5/ /mp/ 子入口，定位类功能需走此入口） |
| dgjr-h5 | 9073 | H5 移动端 |
| dgjr-mp | 9074 | 居民小程序 |
